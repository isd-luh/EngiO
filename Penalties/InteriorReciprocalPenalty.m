...
classdef InteriorReciprocalPenalty
    % INTERIORRECIPROCALPENALTY is a static constraint handling technique.
    % The penalty function has reciprocal slope in the feasible region.
    %
    % LITERATURE:
    ...
    methods
        ...
        function this = InteriorReciprocalPenalty(r)
        ...
        function penalty = penaltyFunction(this, nObj, g)
            ...
            % Return reciprocal penalty if feasible(g>=0), Inf if otherwise
            penalty = this.r * (1/g)';
            if g<0
                penalty = Inf(1, nObj);
            end
